define([
    ...
    return declare('FilterGrid', [
        ...
        constructor: function (params) {
            ...
            if (typeof params.filterBarNode === 'object') {
                this.filterBarNode = params.filterBarNode;
            } else throw new TypeError('filterBarNode is missing or is not an object');
        ...
        loadContent: function () {
            ...
            return response.then(function (response) {
                ...
                grid.totalCount = grid.collection.totalCount;
