define([
    ...
    return declare("QueryableStore", [Rest, Store], {
        ...
        query: function (queryObject) {
            ...
            return new QueryResults(rawResponse.then(
                function (response) {
                    /*store._parseTotalCount(response);*/
        ...
        _parseTotalCount: function (response) {
            return parseInt(response.getHeader('Content-Range').split('/')[0]);
        }
    })
});