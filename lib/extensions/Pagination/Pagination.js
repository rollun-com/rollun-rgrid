        ...
        return declare("Pagination", [_WidgetBase], {
            ...
            buildRendering: function () {
                ...
                if (grid.getTotalCount()) {
                    this._finishRendering(grid.getTotalCount());
                } else {
                    var pagination = this;
                    on.once(grid.domNode, 'reloadedContent', function (event) {
                        pagination._finishRendering(grid.getTotalCount())
                    });
                }
            },
            _finishRendering: function (totalCount) {
                this._updatePaginationStatus(totalCount);
                this._updateNavigation(totalCount);
            },
