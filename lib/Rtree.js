define([
	...
	Dialog,
	domStyle) => {
	return declare('Rtree', [_WidgetBase, _EventDriven], {
		_rqlBuilder: null,
		_datastore: null,
		_tree: null,
		_treeDomNode: null,
		...
		constructor: function (params) {
			...
			if (typeof params.query === 'object') {
				this._rqlBuilder = new RqlBuilder({defaultQuery: params.query});
			}
		...
		setQuery: function (query) {
			return this._rqlBuilder.setQuery(query);
		},

		appendQuery: function (query) {
			return this._rqlBuilder.appendQuery(query);
		},
				...
				handlersConfig = [
					...
					},
					{
						...
						handler: function (event) {
							...
							tree._rqlBuilder.addToCache(nodeKey, event.query);
							tree.appendQuery(event.query);
