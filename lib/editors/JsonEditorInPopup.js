	...
	function (declare,
		...
		return declare([_WidgetBase], {
			...
			constructor: function (params) {
				...
				this._editorOptions = params.editorOptions;
			...
			//my hack that adapts this editor for work with dgrid/Editor
			//TODO: find better solution for "dgrid/Editor focus()/blur() problem"
			_restoreCellValue() {
