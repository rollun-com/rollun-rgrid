define([
	...
	return declare('NavPaneMenu', [_WidgetBase], {
		...
		buildRendering: function () {
			...
			this.domNode.appendChild(this._parseConfigFragment(this.layoutConfig));
		},
		...
		_createRouteButton: function (route, label) {
			return domConstruct.toDom(`<a href="${route}" class="btn btn-info" style="background-color: #1e88e5; width:100%">${label}</a>`);
		},
