  ...
  function (declare,
    ...
    return declare([WidgetBase], {
      ...
      constructor: function (params) {
        ...
        if (params.openInvoiceNumber && params.openItemNumber) {
      ...
      _createItemNode: function (itemData) {
        const shortDetailsNode = domConstruct.toDom(`
            <div class="pb-1 d-flex flex-row">
                <div class="mr-2">Part Number: ${itemData.partNumber}</div>
        ...
        const moreDetailsNode = domConstruct.toDom(`
            <div class="row p-1">
                <div class="col-md-6">
                    ...
                    <div>Quantity: ${itemData.title}</div>
