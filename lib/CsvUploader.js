define([
	...
	return declare('CsvUploader', [_WidgetBase], {
		...
		/**
		 * @param params {
		 * 			storeUrl: string, // URL which points to a REST datastore that accepts data in JSON
		 * 			removeNumberOfRows: number, //Indicates number of rows to discard from start of a document
		 **/
