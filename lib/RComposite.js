define([
    ...
    return declare('RComposite', [_WidgetBase], {
        ...
        /**
         * @param widgets {array} - array of rgrid widget configs
         */
        ...
        /**
         * @param widget - rgrid widget config object
         */
        ...
        /**
         * @param config - rgrid widget config
         * @param domNode
         * @returns {object} - widget received from widgetConstructor call
         * @private
         */
         ...
         * @param config {object} - rgrid widget config
         */
