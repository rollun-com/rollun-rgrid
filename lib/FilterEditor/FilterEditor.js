...
define([
		...
		"dojo/text!rgrid/templates/FilterEditor.html"
	],
	function (declare,
			  lang,
			  array,
			...
			buildRendering: function () {
				...
				this.controlPanel.insertNodes(false, [
					{
						...
						'   <span class="fa fa-times controller-tree-icons"></span> ' +
						'   <p>and</p>' +
						'</div>',
						type: ["and"]
					},
					{
						data: ' <div class="text-center">' +
						'           <i class=" fa fa-plus controller-tree-icons"></i> ' +
						'           <p>or</p>' +
						'       </div>',
						type: ["or"]
					},
					{
						data: '<div class="text-center">' +
						'           <span class="controller-tree-icons glyphicon glyphicon-filter"></span> ' +
						'           <p>condition</p>' +
						'      </div>',
						type: ["filter"]
					}
				...
				switch (true) {
					...
					default: {
						...
						filter.name = "Корневая нода, " + this.filter.name;
						filters = [filter];
					}
				}
