        ...
        return declare([_WidgetBase, _TemplatedMixin], {
            ...
            _renderRefreshButton: function () {
                this.refreshButton = new Button({
                    label: "Обновить",
                    iconClass: "flat-update"
                }, this.dataViewer.gridRefreshButtonNode);
            },

            _renderSearchBar: function () {
                this.searchBar = new SearchBar({context: this.dataViewer});
                domConstruct.place(this.searchBar.domNode, this.dataViewer.filterActiveNode);
                on(this.searchBar.searchButton.domNode, "search", lang.hitch(this, function (event) {
                        this._saveSearchFilter(event.filter);
                    })
                )
            },
            ...
            postCreate: function () {
                ...
                this.inherited(arguments);
                this.own(
                    on(this.refreshButton, "click", lang.hitch(this, this._refreshDataViewer)),
                    ...
                    on(this.dataViewer.filterActiveNode, "filterRemovedFromGrid", lang.hitch(this, this._renderSearchBar)),
                );
            },

            _refreshDataViewer: function () {
                this.dataViewer.grid.refresh();
            },

            _saveSearchFilter: function (filter) {
                this.filterControlPanel.store.put(filter, {overwrite: true});
                this.filterControlPanel.filterListGrid.refresh();
            },
            ...
            exchangeData: function (dStore, columns) {
                var self = this;

                self.dataViewer.setColumns(columns);
                self.dataViewer.setStore(dStore);

                self.dataViewer.refresh();
            }
        });
    }
);